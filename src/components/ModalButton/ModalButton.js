    ...
    const { classNames, btntext } = this.props
      ...
      <RadioGroup onChange={this.onChange} value={this.state.value}>
            ...
            <div className="offer-products">
                      ...
                      <div className="offer-prev-price"><span>was AED 207</span> (Save AED 60)</div>
                      ...
                      <div className="offer-prev-price"><span>was AED 414</span> (Save AED 192)</div>
            				</div>
            			</div>
                  ...
                  <div className="offer-prev-price"><span>was AED 621</span> (Save AED 324)</div>
                  </div>
                </div>
                      ...
                      <div className="offer-prev-price"><span>was AED 828</span> (Save AED 456)</div>
            				</div>
            			</div>
            		</div>
      ...
      <Input type="hidden" id="aff_sub1" className="aff_sub1" name="affsub1" value={this.state.gart} />
       ...
       <Input type="hidden" id="version" className="version" name="version" value="version-hairflame2-discount" />
